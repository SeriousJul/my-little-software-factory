...
const CONTROL_DEFINITIONS: readonly ControlDefinition[] = [
	...
	},
	{
		...
		scope: "control-plane",
		actionBar: true,
		// One rung below the section toggle and above the Launch: the ignore is a
		// row key of the Ticket section, and the bar's ladder keeps the section's
		// own navigation ahead of it, so a Ticket bar of 100 columns and wider
		// names the key (ADR 0060, user story 24).
		priority: 44,
		modes: [...baseModes],
		ticketSectionOnly: true,
